...
export type AuthRateLimitWhereInput = {
  ...
  identifierHash?: Prisma.StringFilter<"AuthRateLimit"> | string
...
export type AuthRateLimitWhereUniqueInput = Prisma.AtLeast<{
  action_identifierHash?: Prisma.AuthRateLimitActionIdentifierHashCompoundUniqueInput
  AND?: Prisma.AuthRateLimitWhereInput | Prisma.AuthRateLimitWhereInput[]
  OR?: Prisma.AuthRateLimitWhereInput[]
  NOT?: Prisma.AuthRateLimitWhereInput | Prisma.AuthRateLimitWhereInput[]
  action?: Prisma.StringFilter<"AuthRateLimit"> | string
...
export type AuthRateLimitScalarWhereWithAggregatesInput = {
  ...
  identifierHash?: Prisma.StringWithAggregatesFilter<"AuthRateLimit"> | string
...
export type AuthRateLimitActionIdentifierHashCompoundUniqueInput = {
  action: string
  identifierHash: string
}
...
export type AuthRateLimitOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"action" | "identifierHash" | "attempts" | "windowStartedAt" | "expiresAt" | "updatedAt", ExtArgs["result"]["authRateLimit"]>
...
export interface AuthRateLimitDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const authRateLimitWithActionOnly = await prisma.authRateLimit.findMany({ select: { action: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AuthRateLimits and only return the `action`
   * const authRateLimitWithActionOnly = await prisma.authRateLimit.createManyAndReturn({
   *   select: { action: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more AuthRateLimits and only return the `action`
   * const authRateLimitWithActionOnly = await prisma.authRateLimit.updateManyAndReturn({
   *   select: { action: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AuthRateLimitFieldRefs {
  ...
  readonly identifierHash: Prisma.FieldRef<"AuthRateLimit", 'String'>
