  ...
  return (
    <div className="flex flex-col gap-3 rounded-lg border border-border p-3">
      <div className="space-y-1.5">
        <Label htmlFor={`book-source-name-${initialName}`}>Name</Label>
        <Input
          id={`book-source-name-${initialName}`}
          value={name}
    ...
    <div className="flex flex-col gap-4">
        ...
        {sources.map((source) =>
          editingId === source.id ? (
            <EditRow
              ...
              onSubmit={(input) => submit(`/api/book-sources/${source.id}`, 'PATCH', input)}
            />
          ) : (
            <div
              key={source.id}
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        This can&rsquo;t be undone. Books using this source must be reassigned or removed
                        first.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
      ...
      {creating ? (
        <EditRow
          ...
          onSubmit={(input) => submit('/api/book-sources', 'POST', input)}
        />
      ) : (
